...
```go
import (
    "github.com/opentracing/opentracing-go-jeager/ext"
)
```
...
import (
    ...
    "github.com/opentracing/opentracing-go-jeager/ext"
    otlog "github.com/opentracing/opentracing-go-jeager/log"
    "github.com/yurishkuro/opentracing-tutorial/go-jeager/lib/tracing"
)
```
